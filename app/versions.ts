...
const v2Benefits = [
  {
    title: "₹73.28L Annual Savings",
    description: "₹6.11L/month savings directly improves the bottom line from day one.",
    icon: "rupee",
    color: "emerald",
    highlight: true,
  },
  {
    title: "₹1.09Cr+ Savings Post-2027",
    description: "Basement lock-in expires in 2027 — the ₹3L/month basement rent is also eliminated, pushing monthly savings to ₹9.11L and annual savings beyond ₹1.09Cr.",
    icon: "calendar",
    color: "emerald",
    highlight: true,
...
export const versions: VersionData[] = [
  ...
  },
  {
    ...
    kpis: {
      ...
      currentMonthlyProjected: 3137581,
      urmilGuptaShare: 1192359,
      proposedTotal: 2526889,
      monthlySavings: 610692,
      annualSavings: 7328304,
      savingsPercent: 19,
    },
